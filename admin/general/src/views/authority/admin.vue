  ...
  <div class="app-container calendar-list-container">
    ...
    <el-table :data="list" v-loading.body="listLoading" element-loading-text="拼命加载中" border fit highlight-current-row> 
      ...
      <el-table-column label="登录账号"  align="center">
        <template scope="scope">
          <span class="link-type" @click="handleUpdate(scope.row)">{{scope.row.usercode}}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" prop="created_at" label="修改人" width="100">
        <template scope="scope">
...
<script>
import { admin,editadmin, role } from "@/api/authority.js";
export default {
  data() {
    return {
      list: null,
  ...
  methods: {
    ...
    fetchData() {
      ...
      admin("get", this.listQuery).then(response => {
